...
// Replace ochrance, Ochrance — See README.adoc for details., just run, Ochrance started successfully. with actuals
= ochrance — Quick Start for Users
:toc:
:toclevels: 2

== What is ochrance?

Ochrance — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./ochrance-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/ochrance/wiki
